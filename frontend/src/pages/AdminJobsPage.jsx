...
export default function AdminJobsPage({ session, userData }) {
  ...
  }, [filters.school, filters.search, filters.work_mode, page]);
  ...
  useEffect(() => {
    setPage(1);
  }, [filters.school, filters.work_mode]);
  ...
  const schoolCountLabel = useMemo(() => {
    if (!filters.school) return 'All schools';
                ...
                <HStack justify="space-between" align={{ base: 'start', md: 'center' }} flexWrap="wrap" spacing={4}>
                  <VStack align="start" spacing={2}>
                    ...
                    <Text color="whiteAlpha.900" maxW="2xl">
                      Browse every uploaded job in one place and narrow the list by school, search text, or work mode.
                    </Text>
                  </VStack>
                  ...
                  <CardBody py={16}>
                    <VStack spacing={4}>
                      ...
                      <Text color="gray.500" textAlign="center">
                        Try adjusting the school filter or search term.
                      </Text>
                    </VStack>
                  </CardBody>
                </Card>
          ...
          <ModalBody py={6}>
            <SimpleGrid columns={{ base: 1, lg: 3 }} spacing={6}>
              ...
              <Box bg="blue.50" borderRadius="2xl" p={5} h="fit-content">
                <Text fontSize="xs" textTransform="uppercase" color="blue.600" letterSpacing="wider" fontWeight="bold" mb={4}>
                  Quick Info
                </Text>
